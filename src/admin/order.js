...
import {orders} from './fixedstatus';
    ...
    <div className={classes.root}>
      ...
      >
        {showOrdersLength()}
         {orders.map((o, oindex) => {
           return(
             <Box key={oindex}  borderBottom={1}  m={1}>
               ...
               <List component="nav" aria-label="main mailbox folders">
                  <ListItem button>
                      ...
                      <ListItemText> Transaction ID : {o.transaction_id} </ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                      ...
                      <ListItemText> {showStatus(o)}  </ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                     ...
                     <ListItemText> Order by : {o.user.name}  </ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                     ...
                     <ListItemText> Order ID : {o._id} </ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                     ...
                     <ListItemText> Amount: Rp {o.amount} </ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                     ...
                     <ListItemText> Ordered On : {moment(o.createdAt).format("dddd, MMMM Do YYYY, h:mm:ss a")}</ListItemText>
                  </ListItem>
                  ...
                  <ListItem button>
                     ...
                     <ListItemText> Delivery Address : {o.address} </ListItemText>
                  </ListItem>
             </List>
                <Typography variant="h6">
                ...
                {o.products.map((p, pindex) => (
                 ...
                 <ListItem button>
                  ...
                  <ListItemText> Product Id : {p._id} </ListItemText>
                </ListItem>
                 </List>
                ))}
            <Divider />
